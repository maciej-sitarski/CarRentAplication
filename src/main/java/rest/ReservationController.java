...
public class ReservationController {
  ...
  public Response saveReservation(
      ...
      @PathParam("insuranceFull") String insuranceFull,
      @PathParam("insuranceBasic") String insuranceBasic,
      @PathParam("navigation") String navigation, @PathParam("babyCarrier") String babyCarrier,
      @PathParam("babyCarriesNumbers") String babyCarriesNumbers,
      @PathParam("smallSeat") String smallSeat,
      @PathParam("smallSeatNumbers") String smallSeatNumbers, @PathParam("seat") String seat,
      @PathParam("seatNumbers") String seatNumbers,
      @PathParam("departmentStart") String departmentStart,
      @PathParam("reservationPrice") Long reservationPrice)
    ...
    if (!insuranceBasic.equals("empty")) {
      ...
      Equipment equipment = equipments.stream()
          .filter(equipment1 -> equipment1.getEquipmentType().equals("Ubezpieczenie podstawowe"))
          .findFirst().get();
    ...
    if (!insuranceFull.equals("empty")) {
      ...
      reservationEquipment.setNumber(1L);
      Equipment equipment = equipments.stream()
          .filter(equipment1 -> equipment1.getEquipmentType().equals("Ubezpieczenie pelne"))
          .findFirst().get();
      reservationEquipment.setEquipment(equipment);
      reservationEquipment.setReservation(reservation);
      reservationEquipmentDao.saveReservationEquipment(reservationEquipment);
    ...
    if (!navigation.equals("empty")) {
      ...
      reservationEquipment.setNumber(1L);
      Equipment equipment = equipments.stream()
          .filter(equipment1 -> equipment1.getEquipmentType().equals("Nawigacja GPS")).findFirst()
          .get();
      reservationEquipment.setEquipment(equipment);
      reservationEquipment.setReservation(reservation);
      reservationEquipmentDao.saveReservationEquipment(reservationEquipment);
    ...
    if (!babyCarrier.equals("empty")) {
      ...
      Equipment equipment = equipments.stream().filter(equipment1 -> equipment1.getEquipmentType()
          .equals("Fotelik dla dziecka (nosidelko 0-9kg)")).findFirst().get();
      reservationEquipment.setEquipment(equipment);
      reservationEquipment.setReservation(reservation);
      reservationEquipmentDao.saveReservationEquipment(reservationEquipment);
    }
    ...
    if (!smallSeat.equals("empty")) {
      ...
      Equipment equipment = equipments.stream().filter(
          equipment1 -> equipment1.getEquipmentType().equals("Fotelik dla dziecka (9-36kg)"))
          .findFirst().get();
      reservationEquipment.setEquipment(equipment);
      reservationEquipment.setReservation(reservation);
      reservationEquipmentDao.saveReservationEquipment(reservationEquipment);
    ...
    if (!seat.equals("empty")) {
      ...
      Equipment equipment = equipments.stream().filter(
          equipment1 -> equipment1.getEquipmentType().equals("Podkladka(siedzisko) dla dziecka"))
          .findFirst().get();
      reservationEquipment.setEquipment(equipment);
      reservationEquipment.setReservation(reservation);
      reservationEquipmentDao.saveReservationEquipment(reservationEquipment);
  ...
  public Response deleteReservation(
    ...
    List<ReservationEquipment> reservationEquipments = reservationEquipmentService
        .findReservationEquipmentListByReservationId(reservationId);
    reservationEquipments.forEach(reservationEquipment -> reservationEquipmentDao
        .deleteReservationEquipment(reservationEquipment.getId()));
