...
public class ClientDetailsReservationViewServlet extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp)
    ...
    Template template = templateProvider
        .getTemplate(getServletContext(), "client-reservation-view.ftlh");
    ...
    try {
      Long period = reservationService
          .countingNumberOfDayOfReservation(reservationDto.getStartDate(),
