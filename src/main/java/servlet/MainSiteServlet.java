...
//    List<Car> cars = carDaoBean.findCarsListByDepartment("Gdańsk");
//    for (int i = 0; i < cars.size(); i++) {
//      logger.info(cars.get(i).getModel().getName()+"dupadupadupa");
//    }
//    List<Car> cars1 = carDaoBean.findCarsListByModel("Corsa");
//
//    for (int i = 0; i < cars1.size(); i++) {
//      logger.info(cars1.get(i).getModel().getName()+"aaaaaaaaaaaaaaaaaaaaa");
//    }
